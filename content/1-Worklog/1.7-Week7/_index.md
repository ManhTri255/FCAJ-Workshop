...
* Continue researching and perfecting the system deployment plan on AWS.
* Build overall architecture for the ZeroBug Agent project.
* Create deployment plan and divide work among team members.
...
* Systematized the plan for applying AWS services to the project.
* Built overall deployment architecture and identified AWS services to use.
* Identified the role of each AWS service in the system architecture.
* Completed project development plan as foundation for design and deployment phases.
