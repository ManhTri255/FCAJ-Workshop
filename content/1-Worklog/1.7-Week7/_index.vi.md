...
* Tiếp tục nghiên cứu và hoàn thiện phương án triển khai hệ thống trên AWS.
* Xây dựng kiến trúc tổng thể cho đề tài ZeroBug Agent.
* Lập kế hoạch triển khai và phân chia công việc trong nhóm.
...
* Hệ thống hóa phương án áp dụng các dịch vụ AWS vào đồ án.
* Xây dựng kiến trúc triển khai tổng thể và xác định các dịch vụ AWS sẽ sử dụng.
* Xác định được vai trò của từng dịch vụ AWS trong kiến trúc hệ thống.
* Hoàn thiện kế hoạch phát triển đồ án làm cơ sở cho giai đoạn thiết kế và triển khai.
