...
* Prepare for Workshop deployment of AWS WAF.
...
* Built deployment process for Route 53, CloudFront, and AWS WAF.
* Fully prepared documentation for actual configuration phase.
