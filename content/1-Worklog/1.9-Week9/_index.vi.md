...
* Chuẩn bị triển khai Workshop về AWS WAF.
...
* Xây dựng được quy trình triển khai Route 53, CloudFront và AWS WAF.
* Chuẩn bị đầy đủ tài liệu cho giai đoạn cấu hình thực tế.
