...
* Thực hiện các task nhận 100 USD AWS Credits còn lại.
...
<colgroup>
  ...
  <tbody>
    <tr>
      ...
      <td class="col-task">- Học Module 01-04: Hạ Tầng Toàn Cầu Của AWS <br> - Tìm hiểu về Regions, Availability Zones, Edge Locations và cách AWS triển khai hạ tầng trên phạm vi toàn cầu</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện Module 01-Lab07-01: Create Budget by Template <br> - Tìm hiểu cách sử dụng các mẫu ngân sách có sẵn để theo dõi và kiểm soát chi phí trên AWS <br> - Thực hiện Task Amazon Bedrock để tìm hiểu dịch vụ AI tạo sinh trên AWS</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện Module 01-Lab07-02: Create Cost Budget Tutorial <br> - Tạo ngân sách chi phí (Cost Budget) và cấu hình các ngưỡng cảnh báo khi vượt mức chi tiêu dự kiến <br> - Thực hiện Task Aurora and RDS</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện Module 01-Lab07-03: Creating a Usage Budget in AWS <br> - Tìm hiểu cách tạo ngân sách dựa trên mức sử dụng tài nguyên AWS và thiết lập các cảnh báo tương ứng <br> - Thực hiện Task AWS Lambda</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện Module 01-Lab07-04: Creating a Reservation Instance (RI) Budget <br> - Tìm hiểu cơ chế quản lý ngân sách đối với Reserved Instances và cách theo dõi mức độ sử dụng nhằm tối ưu chi phí vận hành <br> - Thực hiện Task Amazon EC2</td>
...
* Hoàn thành 04 nhiệm vụ thực hành:
  ...
  * AWS Lambda
  * Amazon EC2
* Nhận thành công 100 USD AWS Credits còn lại để phục vụ học tập và thực hành trên AWS.
